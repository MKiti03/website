...
class Dicipline(models.Model):
    ...
    simple_description = models.TextField(max_length=400, null=True, help_text='Simple description for this dicipline in maximum of 500 letters')
...
class Speciality(models.Model):
    ...
    dicipline = models.ForeignKey(Dicipline, null=True, on_delete=models.PROTECT)
    study_level = models.ManyToManyField(DiciplineTag)
    speciality_name = models.CharField(max_length=254, null= True)
    speciality_description = RichTextField(null = True)
...
class University(models.Model):
    ...
    choose_country = models.ForeignKey(Country, on_delete=models.PROTECT, null=True)
...
class Program(models.Model):
    ...
    study_level = models.ManyToManyField(DiciplineTag)
    program_speciality = models.ForeignKey(Speciality, null=True, on_delete=models.PROTECT)
    choose_university = models.ForeignKey(University, on_delete=models.PROTECT, null=True)
